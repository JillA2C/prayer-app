...
const CHURCHES = [
  { id: 'st_michael', name: 'AMC Paudpod', tagline: 'Growing in Faith, United in Prayer', icon: '鉀�' },
  { id: 'holy_trinity', name: 'AMC Carael', tagline: 'One Faith, One Family', icon: '鉁�' },
  { id: 'public', name: 'Public Prayers', tagline: 'Open prayer wall for everyone', icon: '馃實' },
];
